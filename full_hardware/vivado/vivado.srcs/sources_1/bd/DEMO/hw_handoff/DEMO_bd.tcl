...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net BTN0_0_1 [get_bd_ports BTN0] [get_bd_pins debouncer_0/btn_AL] [get_bd_pins ila_0/probe2]
  ...
  connect_bd_net -net axi_gpio_2_ip2intc_irpt [get_bd_pins axi_gpio_2/ip2intc_irpt] [get_bd_pins ila_0/probe1] [get_bd_pins xlconcat_0/In3]
  ...
  connect_bd_net -net debouncer_0_press [get_bd_pins debouncer_0/press] [get_bd_pins ila_0/probe3] [get_bd_pins xlconcat_1/In0]
