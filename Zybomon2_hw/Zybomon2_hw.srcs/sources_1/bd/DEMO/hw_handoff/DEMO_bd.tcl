...
proc create_root_design { parentCell } {
  ...
  set lirc [ create_bd_port -dir I lirc ]

  # Create instance: axi_buzzer_0, and set properties
  set axi_buzzer_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_buzzer:1.0 axi_buzzer_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_PROBE_OUT0_INIT_VAL {0x00FF} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M08_AXI [get_bd_intf_pins axi_buzzer_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M08_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M08_AXI] [get_bd_intf_pins ila_1/SLOT_0_AXI] [get_bd_intf_pins ps7_0_axi_periph/M08_AXI]

  # Create port connections
  connect_bd_net -net BTN0_0_1 [get_bd_ports BTN0] [get_bd_pins debouncer_0/btn_AL]
  connect_bd_net -net BTN1_0_1 [get_bd_ports BTN1] [get_bd_pins debouncer_1/btn_AL]
  connect_bd_net -net BTN_JY_0_1 [get_bd_ports BTN_JY] [get_bd_pins debouncer_2/btn_AL]
  connect_bd_net -net axi_buzzer_0_pwm [get_bd_ports BUZZER_PWM] [get_bd_pins axi_buzzer_0/pwm]
  connect_bd_net -net axi_gpio_1_ip2intc_irpt [get_bd_pins axi_gpio_1/ip2intc_irpt] [get_bd_pins ila_0/probe3] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net axi_gpio_2_ip2intc_irpt [get_bd_pins axi_gpio_2/ip2intc_irpt] [get_bd_pins ila_0/probe4] [get_bd_pins xlconcat_0/In3]
  ...
  connect_bd_net -net axi_timer_0_interrupt [get_bd_pins axi_timer_0/interrupt] [get_bd_pins ila_0/probe1] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_timer_1_interrupt [get_bd_pins axi_timer_1/interrupt] [get_bd_pins ila_0/probe2] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net debouncer_0_press [get_bd_pins debouncer_0/press] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net debouncer_1_press [get_bd_pins debouncer_1/press] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net debouncer_2_press [get_bd_pins debouncer_2/press] [get_bd_pins xlconcat_1/In2]
  connect_bd_net -net lirc_1 [get_bd_ports lirc] [get_bd_pins axi_gpio_1/gpio_io_i]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_buzzer_0/clk] [get_bd_pins axi_buzzer_0/s00_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_quad_spi_1/ext_spi_clk] [get_bd_pins axi_quad_spi_1/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_timer_1/s_axi_aclk] [get_bd_pins debouncer_0/clk] [get_bd_pins debouncer_1/clk] [get_bd_pins debouncer_2/clk] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins ps7_0_axi_periph/M08_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins vio_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_buzzer_0/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_1/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_timer_1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/M08_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins axi_buzzer_0/vio] [get_bd_pins vio_0/probe_out0]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins axi_gpio_2/gpio_io_i] [get_bd_pins ila_0/probe0] [get_bd_pins xlconcat_1/dout]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_buzzer_0/S00_AXI/S00_AXI_reg] -force
