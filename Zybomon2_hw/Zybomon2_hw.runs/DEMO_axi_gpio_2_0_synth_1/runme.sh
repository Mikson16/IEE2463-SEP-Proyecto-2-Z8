...
HD_PWD='D:/proyectosep2/IEE2463-SEP-Proyecto-2-Z8/input_reader/vivado/vivado.runs/DEMO_axi_gpio_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DEMO_axi_gpio_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DEMO_axi_gpio_2_0.tcl
