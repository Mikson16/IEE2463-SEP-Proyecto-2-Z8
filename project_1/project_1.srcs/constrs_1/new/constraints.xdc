...
#set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { menu_reset }]; #IO_L4N_T0_34 Sch=sw[2]
...
#set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { led }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]
