...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net audio_reader_0_address [get_bd_pins audio_reader_0/address] [get_bd_pins blk_mem_gen_0/addra] [get_bd_pins ila_0/probe4]
  connect_bd_net -net audio_reader_0_buzzer [get_bd_ports buzzer] [get_bd_pins audio_reader_0/buzzer] [get_bd_pins ila_0/probe2]
  connect_bd_net -net audio_reader_0_finished [get_bd_ports finished] [get_bd_pins audio_reader_0/finished] [get_bd_pins ila_0/probe1]
  connect_bd_net -net audio_reader_0_playing [get_bd_ports playing] [get_bd_pins audio_reader_0/playing] [get_bd_pins ila_0/probe0]
  connect_bd_net -net blk_mem_gen_0_douta [get_bd_pins audio_reader_0/audio_ram] [get_bd_pins blk_mem_gen_0/douta] [get_bd_pins ila_0/probe3]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins audio_reader_0/clk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ila_0/clk]
