...
HD_PWD='D:/proyectosep2/IEE2463-SEP-Proyecto-2-Z8/full_hardware/vivado/vivado.runs/DEMO_axi_timer_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DEMO_axi_timer_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DEMO_axi_timer_0_1.tcl
