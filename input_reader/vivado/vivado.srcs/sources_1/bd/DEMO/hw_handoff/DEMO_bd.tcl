...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net axi_gpio_1_ip2intc_irpt [get_bd_pins axi_gpio_1/ip2intc_irpt] [get_bd_pins ila_0/probe1] [get_bd_pins xlconcat_0/In2]
  ...
  connect_bd_net -net lirc_1 [get_bd_ports lirc] [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins ila_0/probe0]
