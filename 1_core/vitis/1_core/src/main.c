...
float volume = 1;
TCHAR *SongFile[2] = {"BATTLE.wav", "BATTLE2.wav"};
...
//    Tirq = XGpio_DiscreteRead(&gpioLight, 1);
//    Lirq = XGpio_DiscreteRead(&gpioLight, 2);
...
//	    xil_printf("musica: %d ",  CurrentByte);
